...
mod core {
    ...
    pub enum StreamPhase {
        /// Post-accept phase
        PostAccept = ngx::ffi::ngx_stream_phases_NGX_STREAM_POST_ACCEPT_PHASE as _,
        /// Pre-access phase
        Preaccess = ngx::ffi::ngx_stream_phases_NGX_STREAM_PREACCESS_PHASE as _,
        /// Access phase
        Access = ngx::ffi::ngx_stream_phases_NGX_STREAM_ACCESS_PHASE as _,
        /// Ssl phase
        Ssl = ngx::ffi::ngx_stream_phases_NGX_STREAM_SSL_PHASE as _,
        /// Pre-read phase
        Preread = ngx::ffi::ngx_stream_phases_NGX_STREAM_PREREAD_PHASE as _,
        /// Content phase
        Content = ngx::ffi::ngx_stream_phases_NGX_STREAM_CONTENT_PHASE as _,
        /// Log phase
        Log = ngx::ffi::ngx_stream_phases_NGX_STREAM_LOG_PHASE as _,
    }
...
mod ssl {
    use ngx::ffi::{ngx_stream_ssl_module, ngx_stream_ssl_srv_conf_t};
